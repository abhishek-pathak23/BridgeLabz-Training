...
logger.Info("╔══════════════════════════════════════════════╗");
logger.Info("║  Fundoo Notes App — Day-16 (NLog + Labels)  ║");
logger.Info("╚══════════════════════════════════════════════╝");
...
try
{
    ...
    using (var scope = app.Services.CreateScope())
    {
        ...
        try
        {
            appLogger.LogInformation("Applying EF Core Migrations for FundooNotesApp Day-16...");
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Fundoo Notes App - Day 16");
