...
public class AuthController : ControllerBase
{
    ...
    /// <summary>
    /// Day-14: JWT Debugger — decodes your JWT token and shows Header, Payload, and all claims.
    /// This is the in-API equivalent of pasting your token into https://jwt.io
    ///
    /// Key Claims to inspect:
    ///   • sub   = UserId (primary identity — immutable, unique)
    ///   • email = Email  (human-readable identifier)
    ///   • role  = User role
    ///   • exp   = Expiry timestamp
    ///   • iss   = Issuer (FundooNotesApp)
    /// </summary>
